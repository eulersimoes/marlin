...
//#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 90, 0 } // Angles for E0, E1
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.6// Z offset: -below +above  [the nozzle]   SE AUMENTAR O VALOR, O NOZZLE FICA MAIS ALTO EM RELAÇÃO A MESA. , - 1.9 FICOU BOM
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,405,100}  // default steps per unit for Ultimaker X,Y,Z,EXTR
#define DEFAULT_MAX_FEEDRATE          {500, 500, 50, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,30,2000}       // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          1200    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  2    // E acceleration in mm/s^2 for retracts
